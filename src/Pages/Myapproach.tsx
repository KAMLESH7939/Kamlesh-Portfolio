...
const Myapproach = () => {
  return (
    <section className="relative w-full h-screen">
      ...
      <section className="absolute top-0 left-0 w-full h-full flex flex-col gap-4 ">
        <h1 className=" text-white text-center font-poppins font-medium text-[3rem] mb-[2rem] honeysingh">
          <div className="flex flex-row justify-center items-center gap-2 "> <div className="honey">My</div> <span className="text-purple-500">Approach</span> </div>
        </h1>
        <div className="my-[2rem] mx-20 flex flex-col lg:flex-row items-center justify-center gap-5">
          <Card
