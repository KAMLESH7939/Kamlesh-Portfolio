      ...
      <section className="absolute top-0 left-0 w-full h-full">
        <section className='relative flex lg:flex-row flex-col max-container gap-10 '>
          ...
          <div className='flex-1 min-w-[50%] flex flex-col'>
            <h1 className='head-text text-white'><span className="text-[3.5rem] font-poppins honey">Get In</span> <span className="text-[#915eff] text-[3.5rem] font-poppins">Touch</span>  </h1>
